  ...
  return (
    <main className="min-h-screen bg-background text-foreground selection:bg-primary/30">
      <div className="relative mx-auto max-w-[1800px] px-4 pb-8 md:px-6">
        ...
        <div className="mt-5 grid items-start gap-2 lg:grid-cols-3 lg:grid-rows-[500px_300px]">
          ...
          <Panel title="类别综合能力" tone="accent" className="order-3 flex h-[500px] min-h-0 flex-col self-start overflow-hidden lg:row-start-1 lg:col-start-2" bodyClassName="flex min-h-0 flex-1 flex-col overflow-hidden p-3">
            <div className="min-h-0 flex-1 overflow-hidden">
